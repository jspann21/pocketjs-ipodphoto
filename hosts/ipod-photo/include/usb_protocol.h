...
typedef enum {
    ...
    PJS_USB_MSG_APPS_LIST = 0x27u,
    PJS_USB_MSG_APP_INSTALL = 0x28u,
    PJS_USB_MSG_APP_REMOVE = 0x29u,
    PJS_USB_MSG_APP_LOAD = 0x2au,
    ...
    PJS_USB_MSG_APPS_LIST_REPLY = 0xa7u,
    PJS_USB_MSG_APP_INSTALL_REPLY = 0xa8u,
    PJS_USB_MSG_APP_REMOVE_REPLY = 0xa9u,
    PJS_USB_MSG_APP_LOAD_REPLY = 0xaau,
